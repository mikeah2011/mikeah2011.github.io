...
highlighter: shiki
lineNumbers: false
title: 馬成軍 · 求職簡報（Slidev 原始稿）
css: unocss
---

<style>
.slidev-layout { font-family: -apple-system, BlinkMacSystemFont, "Segoe UI", "PingFang TC", "Microsoft JhengHei", "Noto Sans TC", sans-serif; }
.slidev-layout {
  background: #0e171b;
  color: #e6eef0;
}
...
<ul class="timeline">
  ...
  <li><span class="t">2017 – 2021</span><span><span class="co">商派雲起 Shopex · Lead Developer</span><span class="what">Apple 中國經銷商平台（5 個月 GMV ¥100 億）· 金番茄獎</span></span></li>
  <li><span class="t">2021 – 2022</span><span><span class="co">徑碩科技 JINGdigital · 資深後端</span><span class="what">MarTech/SCRM 微服務矩陣（10+ 服務）· 埋點追蹤主責</span></span></li>
