...
| 语言与框架 | TypeScript / Node.js、PHP（精通，8 年+）、Go、Python（可读）；Laravel / Hyperf、Gin / go-zero、Vue |
...
全球领先的旅游体验预订平台（覆盖 50+ 国家/地区）。近四年历任联盟营销平台负责人、B2C 主干线核心后端，现兼任售前 CVR 增转专项组负责人；Maestro、VM Health Center 等 AI 工程化项目均为自驱发起。

**1) 售前 CVR 增转专项组 · 负责人（2026 H2 – 至今）**
- 组建并带领 6 人跨端小组，以「CVR 1.2% → 1.8%（+50%）」为唯一北极星指标，搭建 CVR 健康监控看板，使优化成果可视化、可验证

**2) B2C 核心交易链路（2025.02 – 至今，现逐步交接）**
