...
**資深後端工程師 / 技術負責人 · 13 年研發經驗 · 高並發交易系統 · 分散式架構**
...
13 年後端研發經驗，專注**高並發電商交易系統**與**分散式架構**，在 OTA（線上旅遊）、電商、MarTech 領域有完整的業務縱深：從 Apple 中國經銷商平台（5 個月 GMV ¥100 億）到 KKday 聯盟行銷平台與 B2C 主幹線，長期負責交易鏈路的效能、穩定性與架構演進。

**13 年** — 後端研發 · OTA / 電商 / MarTech  
**¥100 億** — Apple 中國經銷商平台上線 5 個月 GMV  
**25s → 2s** — 大型促銷故障搶救後關鍵 API p99  
**200%** — KKday 聯盟業務年增長  
**17.5×** — H5 介面吞吐量提升（200 → 3500 TPS）  
**10+** — 串接全球異業通路（Google / Naver / ShopBack）
...
- **Apple 中國經銷商平台**（上線 5 個月 GMV 超 ¥100 億）：主責預售、交易、支付回調、配送出貨核心鏈路，帶 6–7 人跨端小組（後端／前端／UI）交付小程式端，並負責發版與伺服器維運；串接順豐、寶尊 OMS 等 15+ 支付／物流系統，OMS/WMS 操作自動化率 98%，服務 3500+ 零售門市、25 萬+ DAU
- 高效能優惠券系統獲公司**金番茄獎**；H5 介面吞吐量提升 17.5 倍（200 → 3500 TPS），壓測調校（NGINX 快取 + TSung）達 12K TPS
- 主責**行銷埋點追蹤服務**：全通路行為蒐集與內容行銷歸因，行銷自動化核心資料來源
- 主力參與前後端分離改造（v2）與舊架構維護（合計 300+ 次提交），並橫向涵蓋 EDM、簡訊閘道、問卷、名單開發、企業微信等 8+ 微服務的迭代與穩定性
