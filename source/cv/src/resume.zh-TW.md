...
- **穩定性與團隊**：主導大規模故障搶救（關鍵 API p99 25s+ → <2s，5xx 穩定 <0.01%）；現兼任售前 CVR 增轉專案組負責人，統籌 6 人跨端小組
...
全球領先的旅遊體驗預訂平台（涵蓋 50+ 國家/地區）。近四年歷任聯盟行銷平台負責人、B2C 主幹線核心後端，現兼任售前 CVR 增轉專案組負責人（當前約 80% 精力投入於此，另 20% 用於 B2C 核心鏈路收尾交接）。
