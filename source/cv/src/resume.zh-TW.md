...
- **穩定性與團隊**：主導大規模故障搶救（關鍵 API p99 25s+ → <2s，5xx 穩定 <0.01%）；2026 H2 兼任售前 CVR 增轉專案組負責人，統籌 6 人跨端小組

---

## AI 工程化實踐

- **Maestro**（TypeScript CLI）——**多 AI 審查機器人收斂層**：編排 CodeRabbit / Copilot / Codex / Gemini 4 個機器人，經問題分類 → 三層去重 → 自動修復 → 回覆並解決討論串 → 收斂監控與人工升級判斷，將發散的 AI 意見收斂成可執行的修改佇列；**已成為團隊日常流程**：10 人使用、累計走過 300+ 個 PR；據團隊自評，Code Review 耗時**明顯縮短**、誤報率下降約 70%
...
全球領先的旅遊體驗預訂平台（涵蓋 50+ 國家/地區）。近四年歷任聯盟行銷平台負責人、B2C 主幹線核心後端，2026 H2 兼任售前 CVR 增轉專案組負責人（約 80% 精力投入於此，另 20% 用於 B2C 核心鏈路收尾交接）。
...
- **Apple 中國經銷商平台**（該平台上線 5 個月 GMV 超 ¥100 億）：本人主責預售、交易、支付回調、配送出貨核心鏈路，帶 6–7 人跨端小組交付小程式端，並負責發版與伺服器維運；串接順豐、寶尊 OMS 等 15+ 支付／物流系統，服務 3500+ 零售門市、25 萬+ DAU
