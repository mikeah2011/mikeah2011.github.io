...
**誤報 ~70%↓** — Maestro 收斂 4 個 AI 審查機器人，300+ PR  
...
| 語言與框架 | TypeScript / Node.js、PHP（8 年+）、Go（基礎）、Python（可讀）；Laravel / Hyperf、Vue |
...
全球領先的旅遊體驗預訂平台（涵蓋 50+ 國家/地區）。近四年歷任聯盟行銷平台負責人、B2C 主幹線核心後端，2026 H2 兼任售前 CVR 增轉專案組負責人；Maestro、VM Health Center 等 AI 工程化專案均為自驅發起。
