...
- 以第一贡献人身份主导 KKday 联盟营销平台（两大核心仓库合计 3000+ 次提交），支撑 Google、Naver、ShopBack 等 10+ 全球渠道
...
- **VM Health Center**（TypeScript/Node.js + Slack Bolt + Elasticsearch，79/86 次提交独立开发）：团队作战看板 + 服务健康监控平台——自动聚合 Jira/GitHub/Confluence 生成团队日报周报、订购漏斗与后端服务健康告警、AI 初步根因分析
...
- **技术博客**（Hexo）：1300+ 篇技术文章，覆盖 PHP / 架构 / 数据库 / AI 工程，至今仍在更新
