...
13 年后端研发经验，专注**高并发电商交易系统**与**分布式架构**，横跨 OTA / 电商 / MarTech 三个业务场景。正因为救过大面积线上故障、长期维护核心交易链路，更清楚不可靠的输出流进生产会造成什么后果——近一年将重心延伸至 **AI 工程化**，先建的是收敛层与控费机制，而不是又一个生成器。
...
- **稳定性与团队**：主导大规模故障救火（关键 API p99 25s+ → <2s，5xx 稳定 <0.01%）；2026 H2 兼任售前 CVR 增转专项组负责人，统筹 6 人跨端小组
