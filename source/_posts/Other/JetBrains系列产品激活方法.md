...
---
首先，自行下载[JetBrains](https://www.jetbrains.com/)的产品，通常推荐[JetBrains ToolBox](https://download-cdn.jetbrains.com/toolbox/jetbrains-toolbox-1.26.4.13374.dmg)。

其次，[访问网站](https://3.jetbra.in/)选择对当前网络环境访问效率最好的域名站点。
...
打开PhpStorm使用 code 码激活，鼠标放在 第三步骤的网站中  PhpStorm  `Copy to clipboard` 点击赋值，粘贴激活即可。
