---
title: 'Screenshot Testing 实战：Percy/Chromatic/BackstopJS 视觉回归——Vue 3 组件库的 UI 变更自动检测与 CI 集成'
...
tags: [screenshot testing, percy, chromatic, backstopjs, vue3, 视觉回归, ci]
categories:
  - frontend
