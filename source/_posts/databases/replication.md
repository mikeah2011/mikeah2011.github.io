...
description: '主从同步 master主库，有数据更新，将此次更新的事件类型写入到主库的binlog文件中 主库会创建`log dump 线程`通知slave有数据更新 slave从库，向master节点的 `log dump线程`请求一份指定binlog…'
...
![图片](/images/_config.landscape.png)
