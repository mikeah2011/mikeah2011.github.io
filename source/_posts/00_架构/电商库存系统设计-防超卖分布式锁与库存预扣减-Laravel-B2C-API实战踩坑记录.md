...
categories:
  - 00_架构
tags: [KKday, Laravel, Redis, 微服务]description: 电商库存系统是 B2C 业务的核心难点之一。本文基于 KKday B2C API 的真实项目经验，深入剖析防超卖的三种方案（悲观锁、乐观锁、Redis 原子扣减）、分布式锁的正确使用姿势、以及库存预扣减的完整流程设计，附带踩坑记录与架构图。
---
