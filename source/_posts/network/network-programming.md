...
![图片](/images/网络协议.png)各层网络对应的网络协议
...
![图片](/images/网络数据传输.png)数据在各层之间的传输
...
![图片](/images/网络综合.png)www.baidu.comliu到显示主页

> 各个过程都使用了哪些协议？

![图片](/images/网络过程协议.png)www.baidu.comliu到显示主页过程使用的协议
...
![图片](/images/网络请求方式.png)HTTP请求方式1
...
![图片](/images/网络GET&POST.png)Get和Post区别
...
![图片](/images/网络请求过程.png)HTTP请求的过程和原理
...
![图片](/images/网络HTTP协议变迁.png)HTTP协议变迁
...
![图片](/images/网络HTTPS.png)HTTP和HTTPS
...
![图片](/images/网络SSL.png)https主要流程

这里还画了一张更详尽的图：

![图片](/images/网络HTTPS工作流程图.png)https工作流程详图
...
![图片](/images/网络CA证书.png)证书签名和客户端校验-来源参考[2]
...
![图片](/images/网络COOKIE.png)Cookie和Session
...
![图片](/images/网络SESSION.png)Session和Cookie的关联
...
![图片](/images/网络Session共享.png)Session共享
...
![图片](/images/网络三次握手.png)TCP三次握手示意图
...
![图片](/images/网络三次握手_老王.png)大白话三次握手
...
![图片](/images/网络三次挥手_.png)无三次握手导致端口占用

还有一种情况是已经失效的客户端发出的请求信息，由于某种原因传输到了服务器端，服务器端以为是客户端发出的有效请求，接收后产生错误。

![图片](/images/网络响应失效请求.png)响应生效请求
...
![图片](/images/网络三次握手_TCP.png)三次握手中创建的队列
...
![图片](/images/网络四次挥手_谈恋爱.png)大白话四次挥手
...
![图片](/images/网络一个来回.png)2MSL恰好一个来回
...
![图片](/images/网络关闭等待.png)TIME_WAIT状态的作用
...
![图片](/images/网络TCP报文.png)TCP报文首部的格式
...
![图片](/images/网络TCP可靠性.png)TCP保证可靠性的方法
...
![图片](/images/网络TCP流量控制.png)TCP流量控制
...
![图片](/images/网络破解水管.png)破解的水管-图片来源网络
...
![图片](/images/网络拥塞控制算法.png)拥塞控制常用算法
...
![图片](/images/网络慢启动算法.png)慢启动算法

发包的个数是指数性的增⻓。

![图片](/images/网络慢启动.png)慢启动呈指数型增长
...
![图片](/images/网络快速恢复算法.png)快速恢复算法

### 42.说说 TCP 的重传机制？

重传包括**超时重传、快速重传、带选择确认的重传（SACK）、重复 SACK 四种**。

![图片](/images/网络TCP重传分类.png)TCP重传分类
...
![图片](/images/网络SACK机制.png)SACK机制-来源参考[3]
...
![图片](/images/网络ACK丢包.png)ACK丢包-来源参考[3]
...
![图片](/images/网络TCP 的粘包和拆包.png)TCP 的粘包和拆包
...
![图片](/images/网络TCP&UDP区别.png)TCP和UDP区别

可以这么形容：TCP是打电话，UDP是大喇叭。

![图片](/images/网络TCP&UDP.png)TCP和UDP比喻
...
![图片](/images/网络ipv4.png)IPV4不够解决办法
...
![图片](/images/网络ip&mac.png)IP地址和MAC地址
...
![图片](/images/网络安全攻击.png)主动攻击和被动攻击
...
![图片](/images/网络DNS劫持.png)DNS劫持示意图
