...
;{
  ...
  function renderCats() {
    ...
    if (!container || container.dataset.catsLoaded) return;
  ...
  function checkAndRender() {
    ...
    if (p === "/category" || p === "/category/") {
      // Try immediately, then retry with delays for SPA to finish rendering
      renderCats();
      setTimeout(renderCats, 500);
      setTimeout(renderCats, 1500);
      setTimeout(renderCats, 3000);
    }
  }
  
  // Run on DOMContentLoaded and after short delays
